...
<form action="{{ route('product-color.update',$color->id) }}" method="POST" enctype="multipart/form-data">
    @csrf
    @method('PUT')
    <div class="row">
        <div class="col-xs-12 col-sm-6 col-md-4 mb-2">
            <div class="form-group">
                ...
                <input type="text" name="color_name" class="form-control" placeholder="Name" value="{{ $color->color_name }}">
            </div>
        </div>
