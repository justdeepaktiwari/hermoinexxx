...
@section('title', 'Welcome - Hermoinexxx')
        ...
        <div class="col-md-6 col-12">
            <div class="right-column ms-auto">
                ...
                <video class="video-1" autoplay="" playsinline="" muted="" loop="">
                    <source src="{{ asset('uploads/'.$foot_fetish->video_url) }}" type="video/mp4">
                </video>
            </div>
        </div>
    </div>
    ...
    <div class="section-container d-flex justify-content-between flex-wrap text-white">
        <div class="col-md-6 col-12">
            <div class="right-column me-auto">
                ...
                @endphp
                <video class="video-1" autoplay="" playsinline="" muted="" loop="">
                    <source src="{{ asset('uploads/'.$bdsm_video->video_url) }}" type="video/mp4">
                </video>
            </div>
        </div>
        <div class="col-md-6 col-12">
                ...
                <div class="col-md-4 col-sm-4 col-4 border border-dark ">
                    <a href="http://video">
                        <video class="w-100 h-100" autoplay="" playsinline="" muted="" loop="">
                            <source src="{{ asset('uploads/'.$cum_vid->video_url) }}" type="video/mp4">
                        </video>
                    </a>
                </div>
                @endforeach
...
<div id="custom-model">
    <div class="border border-2 border-white rounded-0 p-4 text-white model-class">
        ...
        <a class="border border-danger border-2 my-2 p-2 d-flex align-items-center justify-content-around cursor-pointer position-relative text-decoration-none text-white"  href="{{ route('register') }}">
            <div class="radio-btn me-1">
                <input class="form-check-input" type="radio" name="flexRadioDefault" id="flexRadioDefault{{ $offer->subscription_id }}" onchange="window.location.href = `{{ route('register') }}`">
            </div>
            ...
            <div class="offered-amount cursor-pointer">
                ...
                <div class="offer-div px-2 shadow position-absolute text-center {{ !$offer->percentage_off ? 'invisible' : '' }}">
...
<script type="text/javascript">
    ...
    function checkOutStepOne(email = '', subscription_id = '') {
        ...
        window.location.href = `{{ route("register") }}?user_email=${email}`
