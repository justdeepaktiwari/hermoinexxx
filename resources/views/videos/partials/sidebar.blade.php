<aside class="toggle-with-button d-md-block d-none position-fixed top-0 left-0 col-12 h-100  z-index-99"
    ...
    <div class="position-relative top-change text-white">
                    ...
                    <div class="col-md-4">
                        ...
                        <div class="tabs my-2">
                            <div class="ps-4 p-2 fs-6 fw-700 on-hover-tab" role="button"
                                onclick="window.location.href = `{{ route('categories.video', 'recommended') }}`">
                                <span class="mx-2">
                            ...
                            <div class="ps-4 p-2 fs-6 fw-700 on-hover-tab" role="button"
                                onclick="window.location.href = `{{ route('categories.video', 'most-viewed') }}`">
                                <span class="mx-2">
                                    <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20"
                            ...
                            <div class="ps-4 p-2 fs-6 fw-700 on-hover-tab" role="button"
                                onclick="window.location.href = `{{ route('categories.video', 'top-rated') }}`">
                                <span class="mx-2">
                                    <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20"
                            ...
                            <div class="ps-4 p-2 fs-6 fw-700 on-hover-tab" role="button"
                                onclick="window.location.href = `{{ route('categories.video', 'test') }}`">
                                <span class="mx-2">
                                    <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20"
                            ...
                            <div class="ps-4 p-2 fs-6 fw-700 on-hover-tab" role="button"
                                onclick="window.location.href = `{{ route('categories.video', 'trending-now') }}`">
                                <span class="mx-2">
                                    <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20"
                            ...
                            <div class="ps-4 p-2 fs-6 fw-700 on-hover-tab" role="button"
                                onclick="window.location.href = `{{ route('categories.video', 'most-favorited') }}`">
                                <span class="mx-2">
                                    <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20"
                            ...
                            <div class="ps-4 p-2 fs-6 fw-700 on-hover-tab" role="button"
                                onclick="window.location.href = `{{ route('categories.video', 'newest') }}`">
                                <span class="mx-2">
                                    <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20"
                            ...
                            <div class="ps-4 p-2 fs-6 fw-700 on-hover-tab" role="button"
                                onclick="window.location.href = `{{ route('categories.video', 'longest') }}`">
                                <span class="mx-2">
                                    <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20"
                            ...
                            <div class="col-md-4 video-hover mb-2" role="button">
                                <div class="position-relative" style="height: 100px;">
                                    ...
                                    <video class="video" onmouseover="this.play()"
                                        ...
                                        <source src="{{ asset('uploads/' . $folder . '/poster.' . $type) }}"
                                            type="video/{{ $type }}">
                                    </video>
                ...
                <div class="full-width row">
                    <div class="col-12 mb-2">
                        <span class="fs-4">Top Categories</span> <span
                            class="btn btn-outline-secondary btn-sm float-end px-3 py-0" onclick="window.location.href = `{{ route('categories.video', 'top-categories') }}`">See All</span>
                    </div>
        ...
        <div class="py-2 px-3 history-video-icon d-flex justify-content-center gap-3" role="button"  onclick="window.location.href = `{{ route('term-condition') }}`">
            <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" fill="currentColor"
