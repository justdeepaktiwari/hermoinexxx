<aside class="toggle-with-button d-md-block d-none position-fixed top-0 left-0 col-12 h-100  z-index-99" style="width: 80px;">
    <div class="position-sticky top-change text-white">
        <a class="p-2 d-flex justify-content-center align-items-center gap-3 home-icon position-relative text-decoration-none text-white" href="{{ route('user-videos') }}">
        ...
        <a class="p-2 categories-icon d-flex justify-content-center gap-3  text-decoration-none text-white" role="button">
        ...
        <div style="height: 20px;"></div>
        <div class="p-2 latest-video-icon d-flex justify-content-center gap-3" role="button">
            ...
            <div class="border-danger border-top border-bottom border-end  pop-up-modal-latest-video black-color text-white">
                <div class="full-width row">
                    <div class="col-md-3">
                        <div class="fs-4 fw-bold ms-2">
                            Porn Videos
        ...
        <div style="height: 20px;"></div>
        <div class="p-2 history-video-icon d-flex justify-content-center gap-3" role="button">
            ...
            <div class="border-danger border-top border-bottom border-end  pop-up-modal-history-video black-color text-white">
                <div class="full-width row">
                    <div class="col-md-3">
                        <div class="fs-4 fw-bold ms-2">
                            Porn Videos
...
<div class="small-size-screen-sidebar w-100 black-color  px-2">
    ...
    <div class="position-sticky top-0 text-white px-2">
        <div class="p-2 d-flex justify-content-start align-items-center gap-3 home-icon position-relative" role="button">
            <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" fill="currentColor" class="bi bi-house-door" viewBox="0 0 16 16">
                <path d="M8.354 1.146a.5.5 0 0 0-.708 0l-6 6A.5.5 0 0 0 1.5 7.5v7a.5.5 0 0 0 .5.5h4.5a.5.5 0 0 0 .5-.5v-4h2v4a.5.5 0 0 0 .5.5H14a.5.5 0 0 0 .5-.5v-7a.5.5 0 0 0-.146-.354L13 5.793V2.5a.5.5 0 0 0-.5-.5h-1a.5.5 0 0 0-.5.5v1.293L8.354 1.146ZM2.5 14V7.707l5.5-5.5 5.5 5.5V14H10v-4a.5.5 0 0 0-.5-.5h-3a.5.5 0 0 0-.5.5v4H2.5Z" />
            </svg>
            <span class="text-white fs-6 fw-bold text-nowrap">Home</span>
        </div>
        <div style="height: 20px;"></div>
        <div class="p-2 porn-video-icon d-flex justify-content-start gap-3 position-relative" role="button">
            ...
            <span class="text-white fs-6 fw-bold text-nowrap">History</span>
        </div>
        <div style="height: 20px;"></div>
        <div class="p-2 categories-icon d-flex justify-content-start gap-3" role="button">
            <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" fill="currentColor" class="bi bi-stack" viewBox="0 0 16 16">
                <path d="m14.12 10.163 1.715.858c.22.11.22.424 0 .534L8.267 15.34a.598.598 0 0 1-.534 0L.165 11.555a.299.299 0 0 1 0-.534l1.716-.858 5.317 2.659c.505.252 1.1.252 1.604 0l5.317-2.66zM7.733.063a.598.598 0 0 1 .534 0l7.568 3.784a.3.3 0 0 1 0 .535L8.267 8.165a.598.598 0 0 1-.534 0L.165 4.382a.299.299 0 0 1 0-.535L7.733.063z" />
                <path d="m14.12 6.576 1.715.858c.22.11.22.424 0 .534l-7.568 3.784a.598.598 0 0 1-.534 0L.165 7.968a.299.299 0 0 1 0-.534l1.716-.858 5.317 2.659c.505.252 1.1.252 1.604 0l5.317-2.659z" />
            </svg>
            <span class="text-white fs-6 fw-bold text-nowrap">Categories</span>
        </div>
        <div style="height: 20px;"></div>
        <div class="p-2 latest-video-icon d-flex justify-content-start gap-3" role="button">
            <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" fill="currentColor" class="bi bi-webcam" viewBox="0 0 16 16">
                <path d="M0 6a2 2 0 0 1 2-2h12a2 2 0 0 1 2 2v3a2 2 0 0 1-2 2H9.269c.144.162.33.324.531.475a6.785 6.785 0 0 0 .907.57l.014.006.003.002A.5.5 0 0 1 10.5 13h-5a.5.5 0 0 1-.224-.947l.003-.002.014-.007a4.473 4.473 0 0 0 .268-.148 6.75 6.75 0 0 0 .639-.421c.2-.15.387-.313.531-.475H2a2 2 0 0 1-2-2V6Zm2-1a1 1 0 0 0-1 1v3a1 1 0 0 0 1 1h12a1 1 0 0 0 1-1V6a1 1 0 0 0-1-1H2Z" />
                <path d="M8 6.5a1 1 0 1 0 0 2 1 1 0 0 0 0-2Zm-2 1a2 2 0 1 1 4 0 2 2 0 0 1-4 0Zm7 0a.5.5 0 1 1-1 0 .5.5 0 0 1 1 0Z" />
            </svg>
            <span class="text-white fs-6 fw-bold text-nowrap">Live Cam</span>
        </div>
        <div style="height: 20px;"></div>
        <div class="p-2 history-video-icon d-flex justify-content-start gap-3" role="button">
            <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" fill="currentColor" class="bi bi-broadcast-pin" viewBox="0 0 16 16">
                <path d="M3.05 3.05a7 7 0 0 0 0 9.9.5.5 0 0 1-.707.707 8 8 0 0 1 0-11.314.5.5 0 0 1 .707.707zm2.122 2.122a4 4 0 0 0 0 5.656.5.5 0 1 1-.708.708 5 5 0 0 1 0-7.072.5.5 0 0 1 .708.708zm5.656-.708a.5.5 0 0 1 .708 0 5 5 0 0 1 0 7.072.5.5 0 1 1-.708-.708 4 4 0 0 0 0-5.656.5.5 0 0 1 0-.708zm2.122-2.12a.5.5 0 0 1 .707 0 8 8 0 0 1 0 11.313.5.5 0 0 1-.707-.707 7 7 0 0 0 0-9.9.5.5 0 0 1 0-.707zM6 8a2 2 0 1 1 2.5 1.937V15.5a.5.5 0 0 1-1 0V9.937A2 2 0 0 1 6 8z" />
            </svg>
            <span class="text-white fs-6 fw-bold text-nowrap">Community</span>
        </div>
        <div style="height: 20px;"></div>
        <div class="p-2 history-video-icon d-flex justify-content-start gap-3" role="button">
            <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" fill="currentColor" class="bi bi-person-hearts" viewBox="0 0 16 16">
            ...
            <span class="text-white fs-6 fw-bold text-nowrap">Members</span>
        </div>
        <div style="height: 20px;"></div>
        <div class="p-2 history-video-icon d-flex justify-content-start gap-3" role="button">
            <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" fill="currentColor" class="bi bi-bookmarks" viewBox="0 0 16 16">
            ...
            <span class="text-white fs-6 fw-bold text-nowrap">About Us</span>
        </div>
        <div style="height: 20px;"></div>
        <div class="p-2 history-video-icon d-flex justify-content-start gap-3" role="button">
            <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" fill="currentColor" class="bi bi-chat-heart" viewBox="0 0 16 16">
            ...
            <span class="text-white fs-6 fw-bold text-nowrap">Chat Support</span>
        </div>
        <div style="height: 20px;"></div>
        <div class="p-2 history-video-icon d-flex justify-content-start gap-3" role="button">
            <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" fill="currentColor" class="bi bi-award" viewBox="0 0 16 16">
            ...
            <span class="text-white fs-6 fw-bold text-nowrap">Term Of Services</span>
        </div>
        ...
        <div class="p-2 history-video-icon d-flex justify-content-start gap-3" role="button">
            ...
            <span class="text-white fs-6 fw-bold text-nowrap">Language</span>
        </div>
    </div>
</div>