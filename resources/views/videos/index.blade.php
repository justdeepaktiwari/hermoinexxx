...
@section('content')
    <div
        class="text-white navbar-section border-bottom border-dark position-sticky top-0 d-flex justify-content-between flex-wrap align-items-center">
        ...
        <div class="search-bar col-md-5 col-8 d-flex align-items-center flex-wrap gap-2">
    ...
    <aside class="toggle-with-button d-md-block d-none position-fixed top-0 left-0 col-12 h-100  z-index-9" style="width: 5%;">
        <div class="position-sticky top-20 text-white">
            ...
            <div style="height: 40px;"></div>
            <div class="text-center" role="button">
                <svg xmlns="http://www.w3.org/2000/svg" width="28" height="28" fill="currentColor" class="bi bi-stack" viewBox="0 0 16 16">
            ...
            <div style="height: 40px;"></div>
            <div class="text-center" role="button">
                <svg xmlns="http://www.w3.org/2000/svg" width="28" height="28" fill="currentColor" class="bi bi-award" viewBox="0 0 16 16">
            ...
            <div class="pagination-section py-3 text-center">
                <nav aria-label="Page navigation example bg-danger">
                    <ul class="pagination justify-content-center">
                        ...
                        <li class="page-item"><a class="page-link  bg-dark border-danger text-white" href="#">4</a>
                        </li>
                        <li class="page-item"><a class="page-link  bg-dark border-danger text-white" href="#">5</a>
                        </li>
                        <li class="page-item"><a class="page-link  bg-dark border-danger text-white" href="#">6</a>
                        </li>
                        <li class="page-item"><a class="page-link  bg-dark border-danger text-white" href="#">7</a>
                        </li>
                        <li class="page-item"><a class="page-link  bg-dark border-danger text-white" href="#">8</a>
                        </li>
                        <li class="page-item"><a class="page-link  bg-dark border-danger text-white" href="#">9</a>
                        </li>
        ...
        $(document).ready(function() {
            $(".toogle-btn span").click(function(e) {
                ...
                if($(this).hasClass("active")){
                    ...
                    $(".toggle-with-button").find("div").removeClass("d-none");
                    ...
                    $(".toggle-with-button").find("div").addClass("d-none");
