...
<?php $__env->startSection("title"); ?>
    Hermoinexxx - <?php echo e($search ?? "Listed Video"); ?>
        ...
        <div class="d-flex flex-wrap w-md-responsive p-2 ms-auto mt-3">
            <div class="col-12 row" style="min-height: 400px;">
                <div class="fs-4 fw-bold d-flex justify-content-between my-2 flex-wrap">
                    <?php if($search): ?>
                        <span>Video related - <?php echo e($search); ?></span>
                    <?php else: ?>
                        <span>All Listed Videos</span>
                    <?php endif; ?>
                    <hr class="text-danger w-100">
                </div>
                <?php $__empty_1 = true; $__currentLoopData = $new_video; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $video): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\hermoinexxx\resources\views/videos/search-video.blade.php ENDPATH**/ ?>