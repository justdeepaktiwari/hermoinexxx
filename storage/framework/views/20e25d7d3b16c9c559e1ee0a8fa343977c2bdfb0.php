        ...
        <div class="col-xs-12 col-sm-6 col-md-4 mb-2">
            <div class="form-group">
                ...
                <select name="product_sizes[]" id="product_sizes" class="w-100" multiple>
                    ...
                    <?php $__currentLoopData = $list_size; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $size): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <option value="<?php echo e($size->id); ?>" <?php echo e(in_array($size->id, $product_sizes) ? "selected" : ""); ?>><?php echo e($size->product_size); ?></option>
                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?> 
                </select>
        ...
        <div class="col-xs-12 col-sm-6 col-md-4 mb-2">
            <div class="form-group">
                ...
                <select name="product_colors[]" id="product_colors" class="w-100" multiple>
                    ...
                    <?php $__currentLoopData = $list_color; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $color): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <option value="<?php echo e($color->id); ?>" <?php echo e(in_array($color->id, $product_colors) ? "selected" : ""); ?>><?php echo e($color->color_name); ?></option>
                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?> 
                </select>
