<script>
    ...
    function changeText(elem) {
        ...
        window.location.href = '<?php echo e(route("user-videos.search")); ?>?search=' + elem;
    }
    ...
    function removeItem(elem) {
        ...
        $.ajax({
            type: "GET",
            url: "<?php echo e(route('user-videos.search')); ?>",
            data: {
    ...
    $(document).ready(function() {
        $("#on-focus-show").keyup(function(e) {
            if ($("#on-focus-show").val().length > 3) {
                $.ajax({
                    type: "GET",
                    url: "<?php echo e(route('search.query')); ?>",
                    data: {
...
</script><?php /**PATH C:\xampp\htdocs\hermoinexxx\resources\views/videos/partials/commonjs.blade.php ENDPATH**/ ?>