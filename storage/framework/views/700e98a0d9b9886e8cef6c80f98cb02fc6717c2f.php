<aside class="toggle-with-button d-md-block d-none position-fixed top-0 left-0 col-12 h-100  z-index-99" style="width: 100px;">
    <div class="position-sticky top-change text-white">
        ...
        <a class="py-2 px-3 d-flex justify-content-center align-items-center gap-3 home-icon position-relative text-decoration-none text-white" href="<?php echo e(route('user-videos')); ?>">
            ...
            <div class="pop-up-modal-categories bg-dark text-white font-poppins">
                <div class="full-width row">
                    <div class="col-md-4">
                        ...
                        <div class="tabs my-2">
                            <div class="ps-4 p-2 fs-6 fw-700 on-hover-tab" role="button" onclick="window.location.href = `<?php echo e(route('categories.video', 'recommended')); ?>`">
                                <span class="mx-2">
                            ...
                            <div class="ps-4 p-2 fs-6 fw-700 on-hover-tab" role="button" onclick="window.location.href = `<?php echo e(route('categories.video', 'most-viewed')); ?>`">
                                <span class="mx-2">
                            ...
                            <div class="ps-4 p-2 fs-6 fw-700 on-hover-tab" role="button" onclick="window.location.href = `<?php echo e(route('categories.video', 'top-rated')); ?>`">
                                <span class="mx-2">
                            ...
                            <div class="ps-4 p-2 fs-6 fw-700 on-hover-tab" role="button" onclick="window.location.href = `<?php echo e(route('categories.video', 'test')); ?>`">
                                <span class="mx-2">
                            ...
                            <div class="ps-4 p-2 fs-6 fw-700 on-hover-tab" role="button" onclick="window.location.href = `<?php echo e(route('categories.video', 'trending-now')); ?>`">
                                <span class="mx-2">
                            ...
                            <div class="ps-4 p-2 fs-6 fw-700 on-hover-tab" role="button" onclick="window.location.href = `<?php echo e(route('categories.video', 'most-favorited')); ?>`">
                                <span class="mx-2">
                            ...
                            <div class="ps-4 p-2 fs-6 fw-700 on-hover-tab" role="button" onclick="window.location.href = `<?php echo e(route('categories.video', 'newest')); ?>`">
                                <span class="mx-2">
                            ...
                            <div class="ps-4 p-2 fs-6 fw-700 on-hover-tab" role="button" onclick="window.location.href = `<?php echo e(route('categories.video', 'longest')); ?>`">
                                <span class="mx-2">
            ...
            <div class="pop-up-modal-categories bg-dark text-white p-3">
                <div class="full-width row">
                    <div class="col-12 mb-2">
                        <span class="fs-4">Top Categories</span> <span class="btn btn-outline-secondary btn-sm float-end px-3 py-0">See All</span>
                    </div>
                    <div class="col-md-4 video-hover mb-2" role="button">
                        <div class="position-relative" style="height: 100px;">
                            <video class="video" onmouseover="this.play()" onmouseout="this.pause();this.currentTime=0;" playsinline muted loop>
        ...
        <div class="py-2 px-3 latest-video-icon d-flex justify-content-center gap-3" role="button">
            ...
            <div class="pop-up-modal-latest-video bg-dark text-white font-poppins">
                <div class="full-width row">
                    ...
                    <div class="col-md-8 row  p-3">
                        <div class="fs-5 mb-3">
                            <span class="fs-5">Models Near You </span> <span class="btn btn-outline-secondary btn-sm float-end px-3 py-0">See All</span>
                        </div>
        ...
        <!-- <div class="py-2 px-3 history-video-icon d-flex justify-content-center gap-3" onclick="document.getElementById('logout-form').submit()" role="button">
            <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" fill="currentColor" class="bi bi-box-arrow-right" viewBox="0 0 16 16">
                <path fill-rule="evenodd" d="M10 12.5a.5.5 0 0 1-.5.5h-8a.5.5 0 0 1-.5-.5v-9a.5.5 0 0 1 .5-.5h8a.5.5 0 0 1 .5.5v2a.5.5 0 0 0 1 0v-2A1.5 1.5 0 0 0 9.5 2h-8A1.5 1.5 0 0 0 0 3.5v9A1.5 1.5 0 0 0 1.5 14h8a1.5 1.5 0 0 0 1.5-1.5v-2a.5.5 0 0 0-1 0v2z"/>
                <path fill-rule="evenodd" d="M15.854 8.354a.5.5 0 0 0 0-.708l-3-3a.5.5 0 0 0-.708.708L14.293 7.5H5.5a.5.5 0 0 0 0 1h8.793l-2.147 2.146a.5.5 0 0 0 .708.708l3-3z"/>
            </svg>
            <span class="text-white fs-6 fw-700 d-none text-nowrap">LogOut</span>
        </div>
...
</div><?php /**PATH C:\xampp\htdocs\hermoinexxx\resources\views/videos/partials/sidebar.blade.php ENDPATH**/ ?>