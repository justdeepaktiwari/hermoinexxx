<aside class="toggle-with-button d-md-block d-none position-fixed top-0 left-0 col-12 h-100  z-index-99"
    ...
    <div class="position-sticky top-change text-white">
        ...
        <a class="py-2 px-3 d-flex justify-content-center align-items-center gap-3 home-icon position-relative text-decoration-none text-white"
            href="<?php echo e(route('user-videos')); ?>">
        ...
        <a class="py-2 px-3 categories-icon d-flex justify-content-center gap-3  text-decoration-none text-white"
            role="button">
            <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" fill="currentColor"
            ...
            <div class="pop-up-modal-categories bg-dark text-white font-poppins">
                <div class="full-width row">
                    <div class="col-md-4">
                        ...
                        <div class="tabs my-2">
                            <div class="ps-4 p-2 fs-6 fw-700 on-hover-tab" role="button"
                                onclick="window.location.href = `<?php echo e(route('categories.video', 'recommended')); ?>`">
                                <span class="mx-2">
                            ...
                            <div class="ps-4 p-2 fs-6 fw-700 on-hover-tab" role="button"
                                onclick="window.location.href = `<?php echo e(route('categories.video', 'most-viewed')); ?>`">
                                <span class="mx-2">
                                    <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20"
                            ...
                            <div class="ps-4 p-2 fs-6 fw-700 on-hover-tab" role="button"
                                onclick="window.location.href = `<?php echo e(route('categories.video', 'top-rated')); ?>`">
                                <span class="mx-2">
                                    <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20"
                            ...
                            <div class="ps-4 p-2 fs-6 fw-700 on-hover-tab" role="button"
                                onclick="window.location.href = `<?php echo e(route('categories.video', 'test')); ?>`">
                                <span class="mx-2">
                                    <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20"
                            ...
                            <div class="ps-4 p-2 fs-6 fw-700 on-hover-tab" role="button"
                                onclick="window.location.href = `<?php echo e(route('categories.video', 'trending-now')); ?>`">
                                <span class="mx-2">
                                    <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20"
                            ...
                            <div class="ps-4 p-2 fs-6 fw-700 on-hover-tab" role="button"
                                onclick="window.location.href = `<?php echo e(route('categories.video', 'most-favorited')); ?>`">
                                <span class="mx-2">
                                    <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20"
                            ...
                            <div class="ps-4 p-2 fs-6 fw-700 on-hover-tab" role="button"
                                onclick="window.location.href = `<?php echo e(route('categories.video', 'newest')); ?>`">
                                <span class="mx-2">
                                    <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20"
                            ...
                            <div class="ps-4 p-2 fs-6 fw-700 on-hover-tab" role="button"
                                onclick="window.location.href = `<?php echo e(route('categories.video', 'longest')); ?>`">
                                <span class="mx-2">
                                    <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20"
                    ...
                    <div class="col-md-8 row  p-3">
                        ...
                        <?php $__currentLoopData = $sidebar_recomonded_video; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $video): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <div class="col-md-4 video-hover mb-2" role="button">
                                <div class="position-relative" style="height: 100px;">
                                    ...
                                    <video class="video" onmouseover="this.play()"
                                        ...
                                        <source src="<?php echo e(asset('uploads/' . $folder . '/poster.' . $type)); ?>"
                                            type="video/<?php echo e($type); ?>">
                                    </video>
                                ...
                                <div class="d-flex justify-content-between">
                                    <span class="small text-muted">
                                        <?php if($video->video_views_count > 1000): ?>
                                            <?php echo e(number_format($video->video_views_count / 1000, 1)); ?>k
                                        <?php endif; ?> views
            ...
            <div class="pop-up-modal-categories bg-dark text-white p-3">
                <div class="full-width row">
                    <div class="col-12 mb-2">
                        <span class="fs-4">Top Categories</span> <span
                            class="btn btn-outline-secondary btn-sm float-end px-3 py-0" onclick="window.location.href = `<?php echo e(route('categories.video', 'top-categories')); ?>`">See All</span>
                    </div>
                    <?php $__currentLoopData = $sidebar_topcategories_video; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $video): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <div class="col-md-4 video-hover mb-2" role="button">
                            <div class="position-relative" style="height: 100px;">
                                <?php
                                    $type = explode('.', $video->video_url);
                    ...
                    <div class="col-md-12">
                        ...
                        <?php $__currentLoopData = $trending_searches; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $trending_search): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <div class="tags py-1 rounded-1 border text-white d-inline-block mx-2 px-2 my-2"
                                role="button" onclick="changeText(this.innerText)">
                                <?php echo e($trending_search->search); ?>
                    ...
                    <div class="col-md-4">
                        ...
                        <div class="tabs my-2">
                            ...
                            <div class="ps-2 py-2 fs-6">
                                <?php $__currentLoopData = $trending_searches; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $trending_search): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <div class="tags py-1 rounded-1 border text-white d-inline-block mx-2 my-2 px-2"
                                        role="button" onclick="changeText(this.innerText)">
                                        <?php echo e($trending_search->search); ?>
                    ...
                    <div class="col-md-8 row  p-3">
                        ...
                        <div class="col-md-4 video-hover mb-2" role="button">
                            <div class="position-relative" style="height: 100px;">
                                <video class="video" onmouseover="this.play()"
                                    onmouseout="this.pause();this.currentTime=0;" playsinline muted loop>
                                    <source src="<?php echo e(asset('assets/videos/welcome.mp4')); ?>" type="video/mp4">
                                </video>
                                <span class="position-absolute bottom-0 end-0 bg-dark text-white px-2 z-index-9">
                                    4:19
                                </span>
...
<div class="small-size-screen-sidebar w-100 black-color  px-2">
    ...
    <div class="text-end text-white px-2">
        <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" onclick="slideUp()" role="button"
    ...
    <div class="position-sticky top-0 text-white px-2">
        <div class="py-2 px-3 d-flex justify-content-start align-items-center gap-3 home-icon position-relative"
            role="button">
            <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" fill="currentColor"
                class="bi bi-house-door" viewBox="0 0 16 16">
                <path
...
<?php /**PATH C:\xampp\htdocs\hermoinexxx\resources\views/videos/partials/sidebar.blade.php ENDPATH**/ ?>