...
<div class="container-fluid h-100vh showcase">
    <nav class="showcase-top d-flex justify-content-between align-items-center">
        ...
        <div class="right-side-button pe-2">
            ...
            <a class="btn btn-danger rounded-0" href="<?php echo e(route('register')); ?>">Sign Up</a>
        </div>
    </nav>
...
unset($__errorArgs, $__bag); ?>
                    ...
                    <div class="mb-0  text-center">
                        ...
                        <a class="btn btn-link text-white mt-2" href="<?php echo e(route('password.request')); ?>">
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\hermoinexxx\resources\views/auth/login.blade.php ENDPATH**/ ?>