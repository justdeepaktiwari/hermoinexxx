...
<?php $__env->startSection("title", $video_detail->video_title); ?>
        ...
        <div class="d-flex flex-wrap w-md-responsive p-2 ms-auto mt-3 justify-lg-content-between justify-md-content-between justify-content-center">
            <div class="col-11 d-flex overflow-x-scroll py-2 custom-mx-auto custom-me-md-auto custom-me-lg-auto">
                <div class="owl-carousel carousel-main position-relative">
                    <?php $__currentLoopData = $video_tag; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $video_tag_val): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <div class="border  black-color <?php if(in_array($video_tag_val->id, $related_tag)): ?> border-secondary <?php endif; ?> text-white mx-1 px-3 py-1 rounded-1 text-center cursor-pointer"><a href="<?php if(in_array($video_tag_val->id, $related_tag)): ?> # <?php else: ?> <?php echo e(route('user-videos.search')); ?>?search=<?php echo e($video_tag_val->name); ?> <?php endif; ?>" class="text-decoration-none <?php if(in_array($video_tag_val->id, $related_tag)): ?> text-muted <?php else: ?> text-white <?php endif; ?>"><?php echo e($video_tag_val->name); ?></a></div>
                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                </div>
            </div>
            <div class="col-md-7 col-12  mt-2 mb-2">
                <div class="d-flex flex-column gap-3">
                    <div class="fs-3 my-2 border border-danger w-100 p-2"><?php echo e($video_detail->video_title); ?></div>
                    <div class="video-section w-100 border border-danger p-2">
                        ...
                        <video class="video" controls controlsList="nodownload">
                            <source src="<?php echo e($video_detail->video_url); ?>" type="video/<?php echo e($type); ?>">
                        </video>
            ...
            <div class="col-md-12 col-12 me-auto  mt-2">
                ...
                <div class="d-flex justify-content-xl-start justify-content-lg-start justify-content-md-start justify-content-center flex-wrap p-2 me-auto mt-3">
                    ...
                    <div class="col-12 row add-more">
                        <?php $__currentLoopData = $related_video; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $video): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    ...
                    <div class="col-12 text-center mt-3 <?php if($related_video_count <= 8): ?> d-none <?php endif; ?>">
                        <div class="col-11 col-md-5 btn btn-secondary btn-sm" onclick="showMore(this, '<?php echo e(json_encode($related_tag)); ?>', '<?php echo e($related_category); ?>', '<?php echo e($related_video_count); ?>')">Show More</div>
                    </div>
                <?php if(count($related_search)): ?>
                    <div class="text-white fw-800 fs-4 col-md-12 col-12 mt-3 mb-2">Releated Searches:</div>
                        <div class="col-md-7 me-auto">
                            <div class="carousel-second owl-carousel">
                                <?php $__currentLoopData = $related_search; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $related_search_item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <div class="border black-color text-white mx-1 px-3 py-1 rounded-1 text-center">
                                        <a href="<?php echo e(route('user-videos.search')); ?>?search=<?php echo e($video_tag_val->name); ?>" class="text-decoration-none text-white">
                                            <?php echo e($related_search_item->search); ?>
...
<script>
    $(document).ready(function() {
        var related_search = '<?php echo e(count($related_search)); ?>';
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\hermoinexxx\resources\views/videos/video-detail.blade.php ENDPATH**/ ?>